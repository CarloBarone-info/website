export const projects = [
  {
    ...
    isProject: true,
    description:
      "A personal portfolio built with React and TypeScript to present my projects, background, and technical skills.",
    impact:
      "Created a live, responsive site deployed through GitHub Pages with an automated deployment workflow.",
  ...
  },
  {
    ...
    isProject: true,
    description:
      "A music portfolio showcasing my arrangements and compositions",
    impact:
      "Improved my skills in music theory, composition, and arrangement across various genres.",
